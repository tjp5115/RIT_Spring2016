// This file was created by: http://www.raytracegroundup.com/
// This is what i am using for my matrix/vector library
#ifndef __NORMAL__
#define __NORMAL__
...
{	
	...
	public:
		...
		Normal(const Point3D p1, const Point3D p2, const Point3D p3); //calculate normal for triangle
